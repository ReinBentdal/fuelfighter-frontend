			...
			<section id="blog-page">
				<div className="grid">
					<div className="two-thirds">
						<h1 className="heavy">Welcome to the blog</h1>
					...
					{endOfTable
						...
						: loading ? <div className="spinner" /> : <button className="suggested-action small-button" onClick={loadMore}>Load more</button>
					}
				</div>
			</section>
			<Footer />
